...
export function CompletionStep({ onComplete }: CompletionStepProps) {
  return (
    <div className="flex flex-col items-center text-center space-y-6 py-8">
      ...
      <h2 className="text-2xl font-bold text-white">Your Trader's Journey Transformation Starts Now!</h2>
      ...
      <div className="pt-4 w-full max-w-xs">
        <Button
          onClick={onComplete}
          className="w-full bg-[#FFD700] text-[#1A1A1A] hover:bg-[#FFD700]/90 font-semibold py-6 transition-all duration-300 hover:scale-105 group"
        >
          <span>Let's Go</span>
