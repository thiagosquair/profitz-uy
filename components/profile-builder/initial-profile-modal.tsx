      ...
      <DialogContent className="sm:max-w-[600px] p-0 bg-white border-gray-200 overflow-hidden">
        ...
        <div className="p-6">
          ...
          {step === 0 && (
            <div className="space-y-6">
              <div className="text-center">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Welcome to ProFitz!</h2>
                ...
                {(["< 1 year", "1-3 years", "3-5 years", "5+ years"] as TradingExperience[]).map((exp) => (
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className="font-medium text-gray-900">{exp}</div>
          ...
          {step === 1 && (
            <div className="space-y-6">
              <div className="text-center">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">What do you trade?</h2>
          ...
          {step === 2 && (
            <div className="space-y-6">
              <div className="text-center">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">What are your trading goals?</h2>
